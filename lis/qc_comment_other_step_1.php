...
function comment_qc($qc_id,$rpt,$ex_code,$disabled)
{
	...
	SUBSTRING(\'111111111|222222222|333333333|4444444444\',1,10*format((result-target)/sd,1) ) Psd,
		...
		';
//////////
	echo '<form method=post action=qc_comment_other_step_1.php>';
...
echo '<table  border=1>	
		<caption><h1>Give QC ID to comment on</h1></caption><form method=post  action=qc_comment_other_step_1.php>';
	echo '<tr>';
