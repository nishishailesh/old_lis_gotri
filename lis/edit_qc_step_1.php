...
function iqc()
{
	...
	if(	$_POST['qc_id']>100000000 and 
		...
		$_POST['repeat']!=NULL)
	{
		$sql_qc_target = 'select * from qc_target where ex_code=\''.$_POST['ex_code'].'\' 
...
echo '<table  border=1>	
		<caption><h1>Miura-300 write QC ID  and repeat number in the box</h1></caption><form method=post  action=edit_qc_step_1.php>';
	echo '<tr>';
