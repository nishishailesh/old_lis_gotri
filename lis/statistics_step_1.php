...
echo '<h3>Calculate monthly summary</h3>';
...
echo '<h3>Calculate monthly sample statistics</h3>';
...
echo '<h3>Calculate monthly Indoor and OPD test statistics</h3>';
echo '<table><form method=post action=\'statistics_step_9.php\'>';
echo '<tr>';
echo '<td>Write "yymm"</td>';
echo '<td><input type=text name=yymm style=\'font-size:150%\' size=3></td>';	
echo '<td><input type=submit value=OK name=submit></td></tr>';
...
echo '<h3>Calculate monthly indiviual sample statistics</h3>';
echo '<table><form method=post action=\'statistics_step_8.php\'>';
echo '<tr>';
echo '<td>Write "yymm"</td>';
echo '<td><input type=text name=yymm style=\'font-size:150%\' size=3></td>';	
echo '<td><input type=submit value=OK name=submit></td></tr>';
...
echo '<h3>Calculate annual statistics</h3>';
