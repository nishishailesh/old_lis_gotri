...
echo '<form method=post action=draw_text_lj.php>';
	echo '<table border=1 cellpadding="0"><th><h1>LJ Chart for Miura-300 & Combisys II</h1></th>';
	echo '<tr>';
		echo '<td>';
		...
		make_array_with_persantage('select distinct ex_code from qc_target', 'ex_code','ex_code');
		echo '</td></tr></table>';
		echo '</td>';
		...
		echo '<tr><td>Select examination code</td><td>';
		make_array_with_persantage('select distinct ex_code from qc_target', 'ex_code','ex_code_2');
		echo '</td></tr></table>';
		echo '</td>';
		echo '<td>';
		echo '<pre>
...
{
echo '<table border=0  cellspacing=0 cellpadding="0" valign=top> <th colspan=12>Miura-300 Internal QC qc_id='.$_POST['qc_id'].' repeat='.$_POST['rpt'].' ex_code='.$_POST['ex_code'].'</th>';
echo '<tr><td><tt>
|-4_______|-3_______|-2_______|-1_______|0_______1|________2|________3|________4|
</tt></td></tr>
';
draw_qc_x($_POST['qc_id'],$_POST['rpt'],$_POST['ex_code']);
echo '</table>';
}
...
{
echo '<table border=0 cellspacing=0 cellpadding="0"> <th colspan=12> Miura-300 Internal QC qc_id='.$_POST['qc_id_2'].' repeat='.$_POST['rpt_2'].' ex_code='.$_POST['ex_code_2'].'</th>';
echo '<tr><td><tt>
|-4_______|-3_______|-2_______|-1_______|0_______1|________2|________3|________4|
</tt></td></tr>
';
draw_qc_x($_POST['qc_id_2'],$_POST['rpt_2'],$_POST['ex_code_2']);
echo '</table>';
}
